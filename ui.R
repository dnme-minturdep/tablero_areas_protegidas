  ...
  navbarPage(title = div(  #### NavBar #####
             ...
             tabPanel("METODOLOGÍA",
                      ...
                      h5(tags$p("La información suministrada permite la clasificación de las visitas en residentes y 
                                         no residentes en 42 Parques Nacionales, en 6 Áreas Naturales Protegidas del Chubut, 1 Parque Provincial en San Juan y 1 Parque en Corrientes. En enero 2024 se incorporó el registro de visitas en el PN Ansenuza y en julio 2024 el PN Islas de Santa Fe.")),
